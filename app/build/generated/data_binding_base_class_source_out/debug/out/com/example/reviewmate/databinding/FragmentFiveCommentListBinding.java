...
public final class FragmentFiveCommentListBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentFiveCommentListBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static FragmentFiveCommentListBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentFiveCommentListBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_five__comment_list, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentFiveCommentListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFiveCommentListBinding((RelativeLayout) rootView, chatListToolbar,

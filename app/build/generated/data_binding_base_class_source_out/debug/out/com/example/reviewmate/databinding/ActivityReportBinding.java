...
public final class ActivityReportBinding implements ViewBinding {
  ...
  private ActivityReportBinding(@NonNull RelativeLayout rootView, @NonNull Toolbar toolbarBack) {
  ...
  public static ActivityReportBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityReportBinding((RelativeLayout) rootView, toolbarBack);
    }

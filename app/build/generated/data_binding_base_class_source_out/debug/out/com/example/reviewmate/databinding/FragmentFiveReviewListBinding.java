...
public final class FragmentFiveReviewListBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static FragmentFiveReviewListBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentFiveReviewListBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_five__review_list, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentFiveReviewListBinding bind(@NonNull View rootView) {
